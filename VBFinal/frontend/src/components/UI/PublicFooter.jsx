        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'} mb-4`}>
              Streamlining complaint management for educational institutions with AI-powered solutions and real-time tracking.
            </p>
            {/* Social Links */}
          ...
          {/* Links Sections */}
          <div>
            <h4 className={`text-sm font-semibold ${isDark ? 'text-white' : 'text-gray-900'} mb-4`}>
              Product
            </h4>
        ...
        <div className={`pt-8 border-t ${isDark ? 'border-gray-800' : 'border-gray-200'}`}>
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
              © {currentYear} CMFS. All rights reserved.
            </div>
