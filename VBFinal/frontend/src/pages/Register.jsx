      ...
      <div className="flex-1 py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className={`${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} p-8 rounded-2xl shadow-2xl border`}>
          <div className="text-center mb-8">
            ...
            <h2 className={`text-3xl font-bold ${isDark ? 'text-white' : 'text-gray-900'} mb-2`}>Create Your Account</h2>
            <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Join Gondar University Complaint Management System</p>
          </div>
