...
const developers = [
  { name: 'XXXX ', role: 'Full Stack Developer', email: 'test@uog.edu.et', github: 'https://github.com/gechkibr', avatar: '👨‍💻' },
  { name: 'XXXX', role: 'Backend Developer', email: 'test@uog.edu.et', github: 'https://github.com/gechkibr', avatar: '🧑‍💻' },
  { name: 'XXXX', role: 'Frontend Developer', email: 'test@uog.edu.et', github: 'https://github.com/gechkibr', avatar: '👩‍💻' },
];
      ...
      <section id="contact" className={`py-20 ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className={`mt-3 text-lg ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>Built with ❤️ for the University of Gondar</p>
          </div>
